  ...
  _createClass(usersController, null, [{
    ...
    value: function () {
      var _registerUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var _req$body, username, email, password, emailExists, salt, hashedPass, user;
    ...
    value: function () {
      var _loginUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var _req$body2, username, email, password, user, validPass, token;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                ...
                return _context2.abrupt("return", res.header('aut-token', token).json({
                  userId: user.userId,
                  username: user.username,
                  email: user.email,
                  password: '********'
